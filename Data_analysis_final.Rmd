...
# this code chunk should install all packages
# Some packages may need to be compiled from source
# so therefore it downloading a Rtools version
# that matches your R-version is a must.


if (!require("pacman")) install.packages("pacman")
pacman::p_load(pak)

if (!require("bookdown")) pak::pak('rstudio/bookdown')


.packages = c("rstudioapi", "rmarkdown",
         "RCurl", "ggplot2", "publish", "tidyverse",
         "rstatix", "ez", "psych", "dplyr",
         "statsExpressions", "ggstatsplot", "tidyr",
         "broom", "ggpubr", "ggsci","gridExtra",
         "ggsignif", "rmarkdoown", "TeachingDemos",
         "citr", "knitr", "jmv", "jtools", "cd")
...
myWorkingDir = (dirname(rstudioapi::getActiveDocumentContext()$path))
setwd(myWorkingDir)
